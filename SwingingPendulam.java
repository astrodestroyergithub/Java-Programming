 ...
 * Press DOWN arrow key to decrease the speed.
 * Press the S key to stop the pendulam swing.
 * Press the R key to resume te swinging of the pendulam.
 */

public class SwingingPendulam extends Application {
